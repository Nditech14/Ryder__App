...
namespace Ryder.Application.User.Query.ForgetPassword
{
    public class ForgetPasswordCommandHandler : IRequestHandler<ForgetPasswordCommand, IResult<ForgetPasswordResponse>>
    {
        ...
        public ForgetPasswordCommandHandler(ISmtpEmailService emailService, IConfiguration configuration, UserManager<AppUser> userManager)
        {
        ...
        public async Task<IResult<ForgetPasswordResponse>> Handle(ForgetPasswordCommand request, CancellationToken cancellationToken)
        {
            try
            {
